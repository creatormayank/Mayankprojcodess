...
String SOS_NUM = "+919685815   ";



//******************* SOS Button Press  *******************//
int SOS_Time = 3; // Press the button 3 sec
...
void Get_gmap_link(bool makeCall)
{
  ...
  else
  {
    ...
    String Gmaps_link = "Emergency! I'm Here " + ( "http://maps.google.com/maps?q=" + lat + "+" + longi); //http://maps.google.com/maps?q=38.9419+-78.3020
